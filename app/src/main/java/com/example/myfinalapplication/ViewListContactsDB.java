...
public class ViewListContactsDB extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(ViewListContactsDB.this,SQLite.class);
        ...
        if(numRows == 0){
            Toast.makeText(ViewListContactsDB.this,"The Database is empty  :(.",Toast.LENGTH_LONG).show();
        }else{
            int i=0;
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    String id2  =userList.get(which_item).getID();
                    Cursor getData = myDB.getData(id2);
                    if (getData.moveToNext()) {
                        ...
                        Toast.makeText(getApplicationContext(), id2 + ". "+dName + ". " + dPhone + ". " + dEmail, Toast.LENGTH_LONG).show();
                    } else
